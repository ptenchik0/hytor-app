...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 05 2021 г., 11:15
...
(1, 'oleg', NULL, '', '', NULL, '', '', NULL, 10, NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 'Борщ пісний', '', '12.30', 0, 0, 2, 1, 0, 0),
(3, 'Вареники з картоплею', '', '31.55', 0, 150, 0, 2, 0, 0);
...
('administrator', 1, NULL, NULL, NULL, 1618248213, 1618248213),
('editOwnModel', 2, NULL, 'ownModelRule', NULL, 1618248213, 1618248213),
